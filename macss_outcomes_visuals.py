...
HTML_PATH = Path("macss_outcomes_spectral_unbolded.html") # swap for desired html path
OUTPUT_DIR = Path("macss_outcomes_assets_spectral_unbolded") # swap for desired output path
